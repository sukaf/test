...
class ProfileDetailView(DetailView):
    ...
    template_name = 'system/registration/profile_detail.html'
    queryset = model.objects.all().select_related('user').prefetch_related('followers',
                                                                           'followers__user',
                                                                           'following', 'following__user')
...
class ProfileUpdateView(UpdateView):
    ...
    template_name = 'system/registration/profile_edit.html'
...
class UserLoginView(SuccessMessageMixin, LoginView):
    ...
    def form_valid(self, form):
        ...
        if not recaptcha_response:
            messages.error(self.request, 'Пожалуйста, подтвердите, что вы не робот!')
